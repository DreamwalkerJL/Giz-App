...
interface InvitesGizInfoAndUsersProps {
  gizCompleteData: gizComplete[] | undefined; 
  loading: boolean; 
...
> = ({ gizCompleteData, loading, error }) => {
  // const formattedTime = gizComplete.time.format("HH:mm:ss");
  // const formattedDate = date.format("DD:MM:YYYY");
  function checkIfTodayOrTomorrow(invite: gizComplete) {
  ...
  function getTimeUntil(invite: gizComplete) {
    const now = dayjs();
            ...
            <div className={styles.gizFrame}>
              <div className={styles.gizInfoAndUsers}>
                <div className={styles.invitesInformationFrame}>
                  ...
                  >{`Made by ${invite.creatorUserName}`}</div>
