...
const StatusGizUsers: FunctionComponent<StatusGizProps> = ({ userName, profilePicture }) => {
      ...
      <div className={styles.checkBarFrame}>
        <div className={styles.checkBar}>
          <div className={styles.checkAccepted}>
            <div className={styles.checkAcceptedT}>1</div>
          </div>
          <div className={styles.checkDeclined}>
            <div className={styles.checkAcceptedT}>1</div>
          </div>
          <div className={styles.checkUndecided}>
            <div className={styles.checkAcceptedT}>4</div>
          </div>
        </div>
      </div>
